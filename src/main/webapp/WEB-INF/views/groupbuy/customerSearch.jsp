				...
				<div class="page-title-wrapper text-center">
					<div class="col-md-12 col-sm-12 col-lg-12">
						<div class="page-title-inner">
							<h1 itemprop="headline">搜尋商品</h1>
							<form class="restaurant-search-form brd-rd2"
								action="${pageContext.request.contextPath}/customerSearchProduct"
								method="post">
								<div class="row mrg10">
									<div class="col-md-6 col-sm-5 col-lg-5 col-xs-12">
										<div class="input-field brd-rd2">
											<input class="brd-rd2" type="text" placeholder="名稱"
												name="item" id="item">
										</div>
									</div>
									<div class="col-md-4 col-sm-4 col-lg-4 col-xs-12">
										<div class="input-field brd-rd2" >
											<!-- <i class="fa fa-map-marker"></i><input class="brd-rd2"
												type="text" placeholder="品項"><i
									...
									<div class="row">
										<div class="col-md-3 col-sm-12 col-lg-3">
											<div class="sidebar left">
												<div class="widget style2 Search_filters">
													<h4 class="widget-title2 sudo-bg-red" itemprop="headline">商品品項</h4>
													<div class="widget-data">
														<ul>
															<li><a href="#" title="" itemprop="url">飲品</a><span></span></li>
															<li><a href="#" title="" itemprop="url">麵食</a><span></span></li>
															<li><a href="#" title="" itemprop="url">飯類</a><span></span>
															</li>
															<li><a href="#" title="" itemprop="url">甜點</a><span></span>
															</li>
															<li><a href="#" title="" itemprop="url">麵包</a><span></span>
															</li>
															<li><a href="#" title="" itemprop="url">Pizza</a><span></span>
															</li>
															<li><a href="#" title="" itemprop="url">水果</a><span></span></li>
															<li><a href="#" title="" itemprop="url">冰品</a><span></span>
															</li>
															<li><a href="#" title="" itemprop="url">其他</a><span></span>
														</ul>
													</div>
												</div>
										...
										<div class="col-md-9 col-sm-12 col-lg-9">
											<div class="title2-wrapper">
												<h3 class="marginb-0" itemprop="headline">商品目錄</h3>
											</div>
														...
														<div class="col-md-6 col-sm-6 col-lg-6">
															<div
																...
																<div class="featured-restaurant-thumb">
																	<a href="<c:url value='/customer/${pro.id}' />"
																		title="" itemprop="url"><img
																		src="<c:url value='/getPictureSeller/${pro.id}'/>"
																		alt="most-popular-img1.png" itemprop="image"></a>
																</div>
																<div class="featured-restaurant-info">
																	<span class="red-clr">>${pro.date}</span>
																	<h4 itemprop="headline">
																		<a href="<c:url value='/customer/${pro.id}' />"
																			title="" itemprop="url">${pro.name}</a>
																	</h4>
																	<ul class="post-meta">

																		<li><i class="flaticon-money"></i>${pro.price}</li>
																	</ul>

																	<span class="food-types">人數: <a href="#"
																		title="" itemprop="url">${pro.peopleNow}/${pro.people}</a></span>
																	<!-- <span class="food-types">滿額人數: <a
                                                                                        href="#" title=""
                                                                                        itemprop="url">${pro.people}</a></span>
                                                                                -->
																	<span class="post-rate yellow-bg brd-rd2"><i
																		class="fa fa-star-o"></i>4.25</span><span
																		class="post-likes style2 red-clr"><i
																		class="fa fa-heart-o"></i>12</span><a class="brd-rd30"
																		href="<c:url value='/customer/${pro.id}' />"
																		title="Order Online"><i
																		class="fa fa-angle-double-right"></i>詳細資訊</a>
																</div>
															</div>
														</div>
													</c:forEach>
