						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="reservation-tab1">
								<form:form class="restaurant-info-form brd-rd5"
									action="${pageContext.request.contextPath}/seller/sellerForm"
