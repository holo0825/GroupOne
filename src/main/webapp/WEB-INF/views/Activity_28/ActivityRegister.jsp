...
<script>
      ...
      //一鍵輸入
        ...
        var topic= ["異國料理輕鬆做"];
        var address= ["台灣高雄市鼓山區大順一路115號"];
        var cost= ["0"];
        var link= ["異國料理輕鬆做Facebook"];
        var introduce= ["全球時尚家電品牌Oster，推出兼具出眾功能與時尚外型的美式經典廚電，"
        	+"讓人不論何時何地都能輕鬆製作出自己的私房菜單，使料理變得時髦又簡單。\n【活動內容】"

        	+"此次活動特別邀請型男主廚Jim，帶領大家用Oster微出國，享受異國料理的滋味\n"

        	+"活動將教大家輕鬆料理2道異國主菜，以及快速製作熱帶綜合果汁。\n"
        	...
        	+">>活動時間：2021/11/20 2pm-3pm(1:30開放入場)"

        	+">>活動地點：高雄義享時尚廣場-B1F hengstyle專櫃"

        	+">>活動地址：高雄市鼓山區大順一路115號B1"

        	+">>活動名額：100位免費入場"

        	+">>示範料理：月亮蝦餅、泰式椒麻雞、熱帶綜合果汁 "];
        var quota= ["100"];
        var startTime= ["2021-11-20 13:30 "];
        var endTime= ["2021-11-20 15:00 "];
