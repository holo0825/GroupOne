                                            ...
                                            <div class="sign-popup-inner brd-rd5 ">
                                                ...
                                                <div class="sign-form ">
                                                    ...
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input  class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="text" id="fullname" name="fullname" placeholder="姓名" maxlength="10"  required="required"/>
                                                        </div>
                                                        <div class=" col-sm-12  " style="padding-bottom: 5px; margin-left: 28px; color: red;"><form:errors path = "fullname" cssClass = "error" /></div>
                                                        
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input  class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="date" id="dob" name="dob" placeholder="yyyy/mm/dd" maxlength="10" required="required"/>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input  class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="text" id="phoneNumber" name="phoneNumber" placeholder="手機號碼 ex. 09XXXXXXXX" maxlength="10" required="required"/>
                                                        </div>
                                                        <div class=" col-sm-12  " style="padding-bottom: 5px; margin-left: 28px; color: red;"><form:errors path = "phoneNumber" cssClass = "error" /></div>
                                                                                                                    
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input  class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="text" id="homeNumber" name="homeNumber" placeholder="家裡電話 ex. 02XXXXXXXX" maxlength="10"/>
                                                        </div>
                                                        ...
                                                        <!--上傳照片-->
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input  class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="file"  accept="image/*" name="memberMultipartFile" id="file2" required="required" onchange="loadFile(event)" />
                                                        </div>
