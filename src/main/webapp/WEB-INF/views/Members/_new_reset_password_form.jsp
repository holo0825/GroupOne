                ...
                <script>
                    function checkPasswordMatch(fieldConfirmPassword) {
                        if (fieldConfirmPassword.value != $("#password").val()) {
                            fieldConfirmPassword.setCustomValidity("密碼不相符，請再次確認");
                        } else {
                            ...
                            <div class="page-title-wrapper text-center ">
                                <div class="col-md-12 col-sm-12 col-lg-12 ">
                                    <div class="page-title-inner ">
                                        <h1 itemprop="headline ">重設密碼專區</h1>
                                                    ...
                                                    <div class="sign-popup-wrapper brd-rd5 ">
                                                        <div class="sign-popup-inner brd-rd5 ">
                                                            <div class="sign-popup-title text-center ">
                                                                <h4 itemprop="headline ">會員重設密碼</h4>
                                                                <span>請根據以下指示申請變更密碼</span>
                                                            </div>
                                                            <div class="popup-social text-center ">
                                                                <div class="sign-form ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class=" col-sm-12 col-sm-12 col-lg-12 col-xs-12 " style="font-size: 25px; margin-bottom: 15px; color: #f6f6f6; text-align: center; border: solid 2px; background-color: rgb(247, 214, 217)">
                                                                            ...
                                                                            <h3>
                                                                                ...
                                                                                <form action="<c:url value='/reset_password'/>" method="post" style="max-width: 350px; margin: 0 auto;">
                                                                                    ...
                                                                                    <div class="border border-secondary rounded p-3" style="height: 260px;">
                                                                                        <div>
                                                                                            <p>
                                                                                                <input type="password" name="password" id="password" class="form-control" placeholder="請輸入新的密碼" required="required" autofocus="autofocus" />
                                                                                        ...
                                                                                        <div>
                                                                                            <p>
                                                                                                ...
                                                                                                <input type="password" class="form-control" placeholder="請確認您的新密碼" required="required" oninput="checkPasswordMatch(this);" />
                                                                                            </p>
                                                                                        </div>
                                                                                        <div>
                                                                                            <input type="submit" value="重設密碼" class="btn btn-primary" />
                                                                                        </div>
                                                                                    </div>
                                                                                </form>
                                                                            </h3>
