...
<%--                             <span class="ml-1">${admin.fullname} | ${admin.email}</span> --%>
                            ...
                            <c:if test="${user != null}">
	                            ...
	                            <span class="ml-1">正在<b>修改</b>一般會員資料...</span>
		            			
		            		</c:if>
							<c:if test="${user == null}">
	                            <h4>管理員 ${admin.fullname}</h4>
	                            <span class="ml-1">正在<b>新增</b>一般會員資料...</span>
		            		</c:if>
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">一般用戶</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
