                                                ...
                                                <span class="popup-seprator text-center "><i
                                                    ...
                                                    <div class="sign-form ">
                                                        <div class="row">
                                                            ...
                                                            <div class=" col-sm-12 col-sm-12 col-lg-12 col-xs-12 " style="font-size: 25px; margin-bottom: 15px; color: red; text-align: center;">
                                                                ...
                                                                <h3>
                                                                    親愛的用戶，很抱歉，<br> 系統無法確認您的信箱，
                                                                    <br> 請確認信箱是否已驗證或是信箱驗證碼錯誤。
                                                                    <br> 如有其他問題請來信聚點時刻客服，謝謝。
                                                                </h3>
                                                            </div>
