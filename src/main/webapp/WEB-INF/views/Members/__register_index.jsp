...
<!--                                                         <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 "><button class="red-bg brd-rd3 " style="font-size: 20px;" type="submit ">立即註冊 <i class="fas fa-arrow-right"></i></button></div> -->
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 " style="text-align: center"><a href="<c:url value='/register/user'/>"><button class="red-bg brd-rd3 " style="font-size: 20px;" type="button ">立即註冊 <img src="<c:url value='/mySvg/arrow-right.svg'/>"></button></a></div>
...
<!--                                                         <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 "><button class="red-bg brd-rd3 " style="font-size: 20px;" type="submit ">立即註冊 <i class="fas fa-arrow-right"></i></button></div> -->
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 " style="text-align: center"><a href="<c:url value='/register/seller'/>"><button class="red-bg brd-rd3 " style="font-size: 20px;" type="button ">立即註冊 <img src="<c:url value='/mySvg/arrow-right.svg'/>"></button></a></div>
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 " style="text-align: center">
                                                            <a class="sign-btn " href="<c:url value='/login'/>" title=" " itemprop="url " style="font-size: 15px;">已經註冊了嗎？ 登入</a>
