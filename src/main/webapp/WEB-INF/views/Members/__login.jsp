...
<!--     <link rel="stylesheet" href="../../assets/css/responsive.css"> -->
    ...
    <!--Google Recaptcha驗證是否機器人的JavaScript-->
...
//                 if (captchaResponse) {
//                 	alert("captcha code confirmed");
//                 	console.log("form submit and recaptcha OK")
//                 } else {
//                 	e.preventDefault();
//                 	alert("You cannot leave the captcha code empty.");
//                 	console.log("form submit and recaptcha fail")
//                 }
//             });
...
//                         'name': name.length === 0 ? 'Dummy' : name
                        'username': username.length === 0 ? '訪客' : username
                    };
...
//                             alert(data.message);
                	...
                	e.preventDefault();
                	$("#captcha-error").html("登入前請勾選我不是機器人");
                    alert("登入前請勾選我不是機器人");
                }
            });
        });
                ...
                <div class="page-title-wrapper text-center ">
                    <div class="col-md-12 col-sm-12 col-lg-12 ">
                        <div class="page-title-inner ">
                            <h1 itemprop="headline ">登入及註冊</h1><span style="font-size: 50px;">Enjoy Food Together</span>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="sign-popup-wrapper brd-rd5 ">
                                            <div class="sign-popup-inner brd-rd5 ">
                                                <div class="sign-popup-title text-center ">
                                                    <h4 itemprop="headline ">登入</h4><span>使用第三方登入</span>
                                                </div>
...
<!--                                                 	<a class="github brd-rd3 " href="# " title="GitHub " itemprop="url " target="_blank "> -->
                                                ...
                                                <form class="sign-form " action="<c:url value='/login'/>" method="POST">
                                                    <div class="row">
                                                    	<!-- reminder message after registration complete -->
                                                        <div class=" col-sm-12 col-sm-12 col-lg-12 col-xs-12 " 
                                                        	style="font-size: 25px; margin-bottom: 15px; color: red; text-align: center;" >
<!--                                                         	style="font-size: 25px; margin-bottom: 15px; border-radius: 5px; border: hidden; background-color: rgb(247, 214, 217); color: rgb(132, 56, 64); text-align: center;" > -->
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 "><button class="red-bg brd-rd3" style="font-size: 20px;" id="button" type="submit ">登入</button></div>
