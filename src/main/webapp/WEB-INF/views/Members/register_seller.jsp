...
<!--     <link rel="stylesheet" href="../../assets/css/responsive.css"> -->
    ...
    <script type="text/javascript">
     ...
     // Ajax非同步及時查詢username是否已經存在
        ...
        // confirm password or prevent submit
...
//         });
        ...
        // 一鍵輸入註冊資料
        function quickInput(){
			document.getElementById('username').value = 'JackyChen'
			document.getElementById('password').value = 'Helloworld123';
			document.getElementById('password1').value = 'Helloworld123';
			document.getElementById('email').value = 'JackyChen@food.com';
			document.getElementById('fullname').value = 'JackyChen';
...
// 			document.getElementById("female").checked = true;
			...
			document.getElementById('telephoneNumber').value = '0288888888';
			document.getElementById('extensionNumber').value = '#8888';
			document.getElementById('companyName').value = '聚點時刻';
			document.getElementById('companyAddress').value = '台北市中山區復興南路二段50號3樓';
		}
...
<!--                 <div class="fixed-bg " style="background-image: url(assets/images/topbg.jpg); "></div> -->
                ...
                <div class="page-title-wrapper text-center ">
                    <div class="col-md-12 col-sm-12 col-lg-12 ">
                        <div class="page-title-inner ">
                            ...
                            <span style="font-size: 50px;">商家用戶註冊</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section>
            ...
            <div class="block top-padd30" style="padding: 0;">
                <!--調整form表單的位置-->
                                ...
                                <!-- <div class="row"> -->
                                    ...
                                    <div class="col-md-6 col-sm-12 col-lg-6 ">
                                        <div class="sign-popup-wrapper brd-rd5 ">
                                            ...
                                            <!--form標籤開始-->
                                            <form:form id="registerForm" action="./process_seller" method="POST" modelAttribute="sellerRegisterBean" enctype='multipart/form-data'>
                                                <div class="sign-form ">
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="email" id="email" name="email" placeholder="Email " required="required"/>
                                                        </div>
                                                        <div class=" col-sm-12  " style="padding-bottom: 5px; margin-left: 28px; color: red;">${message} <form:errors path = "email" cssClass = "error" /></div>
                                                        
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="password" id="password" name="password" placeholder="密碼 " required="required"/>
                                                        </div>
                                                        <div class=" col-sm-12  " style="padding-bottom: 5px; margin-left: 28px; color: red;"><form:errors path = "password" cssClass = "error" /></div>
                                                        
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="password" id="password1" name="password1" placeholder="確認密碼 " required="required"/>
                                                        </div>
                                                        <div class=" col-sm-12  " style="padding-bottom: 5px; margin-left: 28px; color: red;"><form:errors path = "password1" cssClass = "error" /></div>
                                                        
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input class="brd-rd3 " style="background-color: #fff; font-size: 20px; text-align: center; color: black; font-weight: bold;" type="text" value="請填寫公司負責人資料" disabled="disabled">
                                                        </div>
                                                        
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="text" id="fullname" name="fullname" placeholder="姓名" required="required"/>
                                                        </div>
                                                        <div class=" col-sm-12  " style="padding-bottom: 5px; margin-left: 28px; color: red;"><form:errors path = "fullname" cssClass = "error" /></div>

                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                            <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="date" id="dob" name="dob" placeholder="yyyy/mm/dd" maxlength="10" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 " >
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                                <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="text" id="phoneNumber" name="phoneNumber" placeholder="手機號碼 ex. 09XXXXXXXX" required="required" maxlength="10"/>
                                                            </div>
                                        ...
                                        <div class="sign-popup-wrapper brd-rd5 ">
                                            <div class="sign-popup-inner brd-rd5 ">
                                                ...
                                                <div class="sign-form ">  
                                                    <div class="row ">
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input class="brd-rd3 " style="background-color: #fff; font-size: 20px; text-align: center; color: black; font-weight: bold;" type="text" value="請填寫公司資料" disabled="disabled">
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="text" id="telephoneNumber" name="telephoneNumber" placeholder="公司電話 ex. 02XXXXXXXX" maxlength="10" />
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="text" id="extensionNumber" name="extensionNumber" placeholder="分機號碼 ex. #1234" maxlength="5" />
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="text" id="companyName" name="companyName" placeholder="公司名稱" required="required"/>
                                                        </div>
                                                        <div class=" col-sm-12  " style="padding-bottom: 5px; margin-left: 28px; color: red;"><form:errors path = "companyName" cssClass = "error" /></div>
                                                        
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="text" id="companyAddress" name="companyAddress" placeholder="公司地址" required="required"/>
                                                        </div>
                                                        <div class=" col-sm-12  " style="padding-bottom: 5px; margin-left: 28px; color: red;"><form:errors path = "companyAddress" cssClass = "error" /></div>
                                                        <!--圖片顯示區塊-->
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                        ...
                                                        <!--上傳照片-->
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="file"  accept="image/*" name="memberMultipartFile" id="file"  required="required" onchange="loadFile(event)" />
                                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6 col-lg-3">
                                        <div class="widget about_widget wow fadeIn" data-wow-delay="0.1s">
                                            ...
                                            <p itemprop="description" style="text-align: center;">聚點食刻，共享美食每一刻！<p>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-lg-3">
