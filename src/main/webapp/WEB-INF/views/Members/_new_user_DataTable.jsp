                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">所有一般用戶</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">一般會員資料總攬</h4>
                            </div>
                            <div class="card-body" style="padding-top: 5px;">
                                <div class="table-responsive">
                                    <a href=".\newuser" class="btn btn-success" style="margin-bottom: 10px;">
                                        新增一般會員
                                    </a> &nbsp;&nbsp;
                                    <a href=".\listuser" class="btn btn-success" style="margin-bottom: 10px;">
                                        查詢所有一般會員
                                    </a>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="user" items="${listUser}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <c:out value="${user.homeNumber}" />
                                                    </td>
                                                    <td>
                                                        <c:out value="${user.bonusPoint}" />
                                                    </td>
                                                    <td>
                                                        <a href=".\edituser\<c:out value='${user.id}' />">
...
<!--                                                     <td> -->
<!--                                                         <button class="btn btn-primary" type="button" class="delete"> -->
<!--                                                             AjaxDelete -->
<!--                                                             <img src="./mySvg/trash-2.svg"> -->
<!--                                                         </button> -->
<!--                                                     </td> -->
