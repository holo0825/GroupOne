				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							...
							<td><img width='140' height='100' src="<c:url value='/getPicture/${article.id}' />" /></td>
							<td><font color=black>${article.title}</font></td>
							<td><font color=black>${article.content}</font></td>
