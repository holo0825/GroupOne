					...
					<div class="card">
						<div class="sec-box">
							...
							<table class="table"
								...
								<tr>
									<td><a href="<c:url value='/seller/addmenu' />"> <img
											src="../images/editfood_icon.png"
											style="width: 200px; height: 200vpx;"> 新增菜單
									</a></td>
									<td><a href="<c:url value='/seller/searchallmenu' />">
											<img src="../images/menu_icon.png"
											style="width: 200px; height: 200px;"> 查詢店裡所有菜單
									</a></td>
								</tr>
								<tr>
									<td><a href="<c:url value='/seller/ManageRestaurant' />">
											<img src="../images/kitchen_icon.png"
											style="width: 200px; height: 200vpx;">回餐廳管理
									</a><BR></td>
							...
							<form action="<c:url value='/logout' />" method="post"
									...
									<input type="hidden" name="${_csrf.parameterName}"
										value="${_csrf.token}" /> <input type="submit" value="登出"
										 class="btn btn btn-danger" style="font-size: 150%;">
								</form>
							</div>
						</div>
					</div>
										...
										<div class="logo">
											<h1 itemprop="headline">
												<a href="#" title="Home" itemprop="url"><img
													src="../assets/images/logo2.png" alt="logo.png"
													itemprop="image"></a>
											</h1>
										</div>
