				...
				<div class="col-lg-12">
					<div class="card">
						...
						<div style="text-align: center; font-size: 150%; color: #930000;">
							<b>${seller.fullname} | ${seller.email} 歡迎回來～</b>
						</div>
								...
								<tr>
									<td>
										<button id="button" type="button" class="btn btn-danger">
											<a href="<c:url value='/seller/ManageRestaurant' />">餐廳</a>
										</button>
									</td>
									<td>
										<button id="button" type="button" class="btn btn-success">
											<a href="<c:url value='/seller/sellerList' />">團購</a>
										</button>
									</td>
								</tr>
							...
							<div style="text-align: center; font-size: 150%;">
								<form action="<c:url value='/logout' />" method="post"
									...
									<input type="hidden" name="${_csrf.parameterName}"
										...
										class="btn btn-dark" style="font-size: 150%;">
								</form>
							</div>
						</div>
					</div>
